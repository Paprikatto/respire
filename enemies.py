...
class SkeletonSword(Enemy):
    def __init__(self, position=(0, 0)):
        super().__init__(max_health=100, shield=10, position=position, image_path="Sprites/Enemies/SkeletonSword/idle-1.png", hp_bar_offset= (50, 110))
...
class SkeletonShield(Enemy):
    def __init__(self, position=(0, 0)):
        super().__init__(max_health=120, shield=15, position=position, image_path="Sprites/Enemies/SkeletonShield/idle-1.png", hp_bar_offset= (50, 100))
        self.scale = (4, 4)
...
class Shadow(Enemy):
    def __init__(self, position=(0, 0)):
        super().__init__(max_health=80, shield=5, position=position, image_path="Sprites/Enemies/Shadow/idle-1.png", hp_bar_offset= (0, 120))
        self.scale = (4, 4)
